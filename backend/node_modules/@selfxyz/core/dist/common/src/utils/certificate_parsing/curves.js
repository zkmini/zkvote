...
exports.standardCurves = void 0;
exports.normalizeHex = normalizeHex;
exports.identifyCurve = identifyCurve;
exports.getECDSACurveBits = getECDSACurveBits;
exports.getCurveForElliptic = getCurveForElliptic;
exports.standardCurves = [
    {
        name: 'secp192r1',
...
function identifyCurve(params) {
    ...
    for (const curve of exports.standardCurves) {
        if (normalizedParams.p === normalizeHex(curve.p) &&
