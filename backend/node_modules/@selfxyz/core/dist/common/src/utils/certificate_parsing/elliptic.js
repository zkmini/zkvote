...
exports.initElliptic = initElliptic;
const elliptic_1 = __importDefault(require("elliptic"));
const hash_js_1 = __importDefault(require("hash.js"));
function initElliptic() {
    const curves = elliptic_1.default.curves;
    const PresetCurve = elliptic_1.default.curves.PresetCurve;
