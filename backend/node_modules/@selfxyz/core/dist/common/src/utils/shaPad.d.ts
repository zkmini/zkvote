export declare function shaPad(prehash_prepad_m_array: number[], maxShaBytes: number): [number[], number];
export declare function sha384_512Pad(prehash_prepad_m_array: number[], maxShaBytes: number): [number[], number];
